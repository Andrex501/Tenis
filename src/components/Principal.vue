<template>
  <div id="app">
    <div v-if="isLoading" class="loading-screen">
      <img src="../assets/kenilogo.png" alt="Logo de Carga" class="loading-logo animated-logo">
      <p>Cargando KeniSneakers...</p>
    </div>
    <div v-else>
      <!-- Contenido principal cuando la carga ha finalizado -->
        ...
        <div class="container-fluid">
          ...
          <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDarkNavbar" aria-controls="offcanvasDarkNavbar" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon">
              ...
              <svg class="contactanos" viewBox="0 0 48 48" y="0px" x="0px" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li class="nav-item">
                  <a href="https://wa.me/573209025487?text=Hola Andres,%20quiero%20más%20información" target="_blank">
                  ...
                  <br><br>
                  <a href="https://wa.me/573204084054?text=Hola kevin,%20quiero%20más%20información" target="_blank">
                    <button class="button2">
                      KEVIN
                      <svg viewBox="0 0 48 48" y="0px" x="0px" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4.868,43.303l2.694-9.835C5.9,30.59,5.026,27.324,5.027,23.979C5.032,13.514,13.548,5,24.014,5c5.079,0.002,9.845,1.979,13.43,5.566c3.584,3.588,5.558,8.356,5.556,13.428c-0.004,10.465-8.522,18.98-18.986,18.98c-0.001,0,0,0,0,0h-0.008c-3.177-0.001-6.3-0.798-9.073-2.311L4.868,43.303z" fill="#fff"></path>
        ...
        <div id="carouselExampleAutoplaying" class="carousel slide carroespacios" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="../assets/kenilogo.png" class="carrouno d-block w-90" alt="KeniSneakers Logo">
            </div>
      ...
      <br>
      <center>
        <select class="filtro form-select form-select-lg mb-3 bg-dark text-white border-secondary"
                aria-label="Large select example" v-model="marcaSeleccionada">
          <option value="">👆🏽 y Filtra por Marca (TODOS)</option>
      ...
      <div class="cards-container">
        <div v-for="producto in productosFiltrados" :key="producto._id">
          <div class="card">
            ...
            <img v-show="!producto.cargando" :src="producto.imagen" class="card-img-top" alt="Producto" @load="producto.cargando = false"/>
            <div class="card-body">
              <center>
                <div>
...
const obtenerProductos = async () => {
  try {
    ...
    productos.value = productos.value.map(producto => ({
      ...producto,
      cargando: true // Inicialmente, todos los productos están cargando
    }));
  } catch (error) {
    console.error("Error al obtener productos", error);
    // Maneja el error como desees (mostrar un mensaje, etc.)
  } finally {
    // Oculta la pantalla de carga principal una vez que la petición inicial ha terminado (éxito o fallo)
